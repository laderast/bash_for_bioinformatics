...
Our scripts live in the the `bash_for_bioinformatics/` folder on our machine. We'll need to transfer these scripts, because some of them will be run directly on the DNAnexus workers. 
