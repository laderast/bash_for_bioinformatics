...
Install homebrew to your mac and install `python3` and `pip`:
...
On your own computer/binder, clone the repo (it will already be cloned if you're in the binder version).
