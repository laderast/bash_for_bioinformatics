...
description: |
  ...
  as performing these applications reproducibly.
link-citations: yes
...
- **Build** and **Execute** applets on the DNAnexus platform by specifying the JSON files
...
- **Use** basic Loops in a Shell Script
- **Utilize** pipes and filters
- **Make** a basic shell script that does the following:
    - Takes a file argument
    - Executes a binary on your system on this file
    - Directs the output to standard output
