--- 
title: "Bash for Cloud Bioinformatics"
author: "Ted Laderas"
date: "`r Sys.Date()`"
...
link-citations: yes
github-repo: laderast/shell_for_bioinformatics
---
...
- **Batch Process** multiple files in a project
...
This book is not meant to be a substitute for excellent books such as [Data Science at the Command Line](https://datascienceatthecommandline.com/) or [Genomics in the Cloud](https://www.oreilly.com/library/view/genomics-in-the/9781491975183/), which focuses on the Terra platform.  

In contrast, this book focuses on the essential shell skills (notably Bash) that will help you on the DNAnexus platform.
