...
You may be familar with folder based filesystems as a way to organize your data. The main way to find/refer to a file is through it's path.
...
It turns out it is faster to store data not by rows, but by columns. This is really helpful because the data is sorted by *data* type and it's easier to traverse for this reason. 
