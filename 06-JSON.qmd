...
You'll also need to install `jq` if it's not yet on your system. You can check by typing 

`which jq`


If you're on a Mac, you can use homebrew and 
...
This is the JSON file we're going to be working with, in `data/example.json`.
