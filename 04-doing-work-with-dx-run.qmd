...
Run the above code (also in `04-doing-work-with-dx-run/run-sambamba.sh`) and look at the log that is generated. Take a look at it carefully, especially the output log. 
