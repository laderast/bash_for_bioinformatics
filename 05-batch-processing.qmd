...
In your shell (either on your machine or in binder), make sure you're in the `bash_bioinfo_scripts/05-batch-processing/` folder:

```
cd 05-batch-processing/
```
:::
...
```{bash}
#| eval: false
#| filename: 05-batch-processing/dx-find-data-name.sh
...
```{bash}
#| eval: false
#| filename: 05-batch-processing/dx-find-path.sh
...
```{bash}
#| eval: false
#| filename: 05-batch-processing/dx-find-data-field.sh
...
```{bash}
#| eval: false
#| filename: 05-batch-processing/dx-find-data-class.sh
...
```{bash}
#| eval: false
#| filename: 05-batch-processing/dx-find-xargs.sh
dx find data --name "*.bam" --brief | \
...
```{bash}
#| eval: false
#| filename: 05-batch-processing/batch-on-worker.sh
